...
from constants.constants import APP_LOOP_REPEAT_COUNT
...
if __name__ == '__main__': # This will only run in the main process
    ...
    app = Application(threshold=0.8, initial_scale=1, scale_increment_count=1, image_paths=image_paths, process_id=14672, stop_event= global_stop_event)
    ...
    try:
        for _ in range(APP_LOOP_REPEAT_COUNT):
            app.app_start()
